...
class GameTest {
    ...
    public void insert() {
        ...
        leaguePerSeasons.add(new League(2020, new TwoGameSchedulingMethod(), new RankingMethod(), "Prime League"));
        leaguePerSeasons.add(new League(2021, new TwoGameSchedulingMethod(), new RankingMethod(), "Prime League"));
