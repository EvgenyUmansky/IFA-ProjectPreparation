...
class GameFansDBAccessTest {
    ...
    public void insertBeforeTest() throws SQLException {
        ...
        fanGamesDBAccess = GameFansDBAccess.getInstance();
    ...
    void selectFansOfGame() throws SQLException {
        Pair<String, ArrayList<Fan>> fansEmpty = fanGamesDBAccess.select("");
        ...
        // check select
        ArrayList<Fan> fans = fanGamesDBAccess.select("1000").getValue();
