...
public class User {
    ...
    public static User getUserByID(String userName) {
        ...
        return new User(userName, "1234", null, null).addRoleToUser(Role.TEAM_OWNER).addRoleToUser(Role.ASSOCIATION_AGENT).addRoleToUser(Role.REFEREE).addRoleToUser(Role.TEAM_PLAYER).addRoleToUser(Role.COACH).addRoleToUser(Role.TEAM_MANAGER);
    }
